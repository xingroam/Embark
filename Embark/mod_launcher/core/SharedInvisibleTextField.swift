...
struct SharedInvisibleTextField: NSViewRepresentable {
  ...
  func makeNSView(context: Context) -> CustomNSTextField {
    let textField = SharedSearchTextField.shared.getOrCreateTextField()
  ...
  class Coordinator: NSObject, NSTextFieldDelegate {
    var parent: SharedInvisibleTextField

    init(_ parent: SharedInvisibleTextField) {
      self.parent = parent
    }
